...
export const StoragePage = () => {
    ...
    return (
        <div class="w-full h-full px-4 md:px-5 lg-6 mx-auto relative z-10 rounded bg-gray-700">
            <div class="grid grid-cols-12">
                <div
                    ...
                    <div class="flex items-center justify-between pb-8 border-b border-gray-300">
                        ...
                        <h2 class="font-manrope font-bold text-xl leading-8 text-gray-800">3 Items</h2>
                    </div>
                ...
                <div
                    class="mt-2 rounded-xl col-span-12 xl:col-span-4 bg-gray-50 w-full max-xl:px-6 max-w-3xl xl:max-w-lg mx-auto  py-24 p-10">
