        ...
        <div className="paymentContent ">
            <div className="depositPage ">
                ...
                <div className="noticesBox">
                    ...
                    <ul className="w-full">
                        <li>
                            Bạn có thể sử dụng ví Thinkmay để thanh toán dịch vụ
                            và nâng cấp cấu hình
                        </li>
                        <li>
                            Ví Thinkmay sẽ tự động trừ tiền khi bạn sử dụng hết
                            số giờ và ngày chơi được quy định (xem trong mục{' '}
                            <span className="font-bold text-l text-blue-400">
                                Đăng kí
                            </span>
                            )
                        </li>
                        <li>
                            Khi bạn sử dụng hết thời gian quy định của gói và ví
                            không đủ tiền để tự động gia hạn, dữ liệu của bạn sẽ
                            bị xóa sau{' '}
                            <span className="font-bold text-l text-blue-400">
                                2 ngày
                            </span>
                        ...
                        <li>
                            Như vậy tính năng này giúp bạn không bị gián đoạn
                            khi gia hạn dịch vụ
                        </li>
                        <li>
                            Thinkmay hỗ trợ người dùng nạp tiền vào ví thông qua
                            chuyển khoản ngân hàng
                        </li>
                        <li>
                            Bạn có thể cập nhật các chương trình khuyến mãi để
                            được ưu đãi khi nạp vào ví
                        </li>
                        <li>
                            Tiền trong ví thinkmay không có giá trị quy đổi
                            tương đương ra bất kì đồng tiền nào, cũng không phải
                            là tiền mã hóa
                        </li>
                        <li>
                            Click vào{' '}
                            ...
                            nếu bạn cần các hình thức thanh toán khác
                        </li>
                    </ul>
                    <p className="title mt-3">
                        Như vậy, nạp tiền vào ví thinkmay là một hình thức "nạp
                        để gia hạn thuê bao", giống như tài khoản điện thoại
                    </p>
                </div>
            </div>
        </div>
