  ...
  return (
    <div className="w-[320px] h-[360px] p-6">
      <ul className="list-none flex flex-col  gap-2 pb-4">
        <li>
          Xin chào <strong>{userName}</strong>^^, cảm ơn bạn đã quan tâm tới
          dịch vụ Thinkmay.{" "}
        </li>
        <li>
          Để tiến hành thanh toán gói <strong>{type}</strong>, bạn hãy chuyển
          khoản số tiền <strong>{price}</strong>: kèm với <strong>email</strong>{" "}
          dùng trong Thinkmay.
        </li>
        <li>Ví dụ: {userEmail || "thienvanlea1@gmail.com"}</li>
        <Image src="asset/payment" w={"100%"} />
        <li>
          Sau đó <strong>chụp</strong> lại màn hình và <strong>gửi</strong> về
          cho{" "}
          <a
            className="underline"
